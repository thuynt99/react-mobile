        ...
        <Collapse defaultActiveKey={["1"]}>
          <Panel header="Export options" key="1">
            <Form layout="inline">
              ...
              <Form.Item>
                <Button type="primary" icon="file-excel" onClick={this.handleDownload.bind(null, "all")}>
                  Export all
                </Button>
              </Form.Item>
              <Form.Item>
                <Button type="primary" icon="file-excel" onClick={this.handleDownload.bind(null, "selected")}>
